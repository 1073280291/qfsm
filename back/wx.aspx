<%@ Page Language="C#" AutoEventWireup="true" CodeFile="wx.aspx.cs" Inherits="back_wx" %>
    ...
    <div style="width: 100%;">
        ...
        <span class="icon-bar"></span>                        
                            ...
                            <ul class="nav navbar-nav">
                                ...
                                <li class="active"><a href="wx.aspx">手机维修</a></li>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <ul id="myTab" class="nav nav-tabs">
                            <li >
                                <a href="wx.aspx">已报修</a>
                            </li>
                            <li><a href="?index=ing" >维修中</a></li>
                                    ...
                                    <form action="#" method="post">
                                        <div class="modal-body">
                                            <table class="table table-responsive">
                                                ...
                                                <tr>
                                                    <td colspan="2"><b>手机型号</b></td>
                                                    <td colspan="2" id="xh" class="text-info"></td>
                                                </tr>
                                                <tr>
                                                    <td><b>维修类型</b></td>
                                                    <td  id="type" class="text-info"></td>
                                                    <td><b>备用机</b></td>
                                                    <td  id="by" class="text-info"></td>
                                                </tr>
                                                <tr>
                                                    <td><b>维修日期</b></td>
                                                    <td colspan="3" id="date" class="text-info"></td>
                                                </tr>
                                                <tr>
                                                    <td><b>联系QQ</b></td>
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <input type="submit" class="btn btn-primary" id="tjgg" value="我维修" />
