<%@ Page Language="C#" AutoEventWireup="true" CodeFile="sap.aspx.cs" Inherits="back_sap" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        $(function () {
            ...
            if (str == "ed" || str == "ed#")
            {
                $("#myTab").find("li").eq(3).addClass("active").siblings().removeClass("active");
                //$("#price").attr("readonly", "readonly")
                //$("#tjgg").hide();
                //$("#sccy").hide();
            }
            else if (str == "pr" || str == "pr#") {
                $("#myTab").find("li").eq(0).addClass("active").siblings().removeClass("active");
                $("#price").attr("readonly", "readonly")
                $("#tjgg").hide();
                ///$("#sccy").hide();
            }
            else if (str == "ing" || str == "ing#") {
    ...
    <div style="width: 100%;">
        ...
        <span class="icon-bar"></span>                        
                            ...
                            <ul class="nav navbar-nav">
                                ...
                                <li  class="active"><a href="sap.aspx">绩效查看</a></li>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <ul id="myTab" class="nav nav-tabs">
                            <li><a href="?index=pr" >已下单</a></li>
                            <li><a href="?index=ing" >处理中</a></li>
                            <li >
                                <a href="sap.aspx">未收账</a>
                            </li>
                            <li><a href="?index=ed" >已收账</a></li>
                        </ul>
                    </div>
                    <div class="panel-body">
                        <table class="table table-responsive" id="info">
                            ...
                            <%
                                ...
                                {
                                    Response.Write("<tr><td>" + (i + 1).ToString() + "</td> <td>" + item[i][1].ToString() + "</td> <td>" + item[i][2].ToString() + "</td><td><a href='#' onclick='cz(" + item[i][0] + ")'>操作</a></td></tr>");
                                }
                            %>
                        </table>
                        <script>
                            function cz(index) {
                               // alert(index)
                                $.post("sap.ashx", {
                                    ...
                                    $("#type").text(data["Table"][0].type);
                                    $("#xq").text(data["Table"][0].xq);
                                    $("#person").text(data["Table"][0].person); 
                                    $("#userName").text(data["Table"][0].userName);
                                    $("#price").val(data["Table"][0].pay);
                                    ...
                                    <form action="#" method="post">
                                        <div class="modal-body">
                                             <table class="table table-responsive">
                                                ...
                                                <tr>
                                                    <td><b>主要需求</b></td>
                                                    <td colspan="3" id="xq" class="text-info"></td>
                                                </tr>
                                                <tr>
                                                    <td><b>联系QQ</b></td>
                                                ...
                                                <tr>
                                                 ...
                                                 <tr>
                                                    <td><b>金额</b></td>
                                                    <td class="text-info" colspan="3"><input type='text' id="price"   class='form-control' placeholder='金额' required="required"/></td>
                                                </tr>
                                            </table>
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
                                            <input type="submit" class="btn btn-danger" id="sccy" value="删除订单" />
                                            <input type="button" class="btn btn-primary" id="tjgg" value="已收账" />
                                            <script type="text/javascript">
                                                $("#tjgg").click(function () {
                                                    if ($("#price").val() == "")
                                                    {
