<%@ Page Language="C#" AutoEventWireup="true" CodeFile="oldPhone.aspx.cs" Inherits="back_oldPhone" %>
    ...
    <div style="width: 100%;">
        ...
        <span class="icon-bar"></span>                        
                            ...
                            <ul class="nav navbar-nav">
                                ...
                                <li class="active"><a href="oldPhone.aspx">二手机平台</a></li>
                                        ...
                                        <div class="modal-body">
                                            <table class="table table-responsive">
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="2" id="type" class="text-info"></td>
                                                </tr>
                                                <tr>
                                                    <td><b>联系QQ</b></td>
